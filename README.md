# Quarkus Hibernate ORM Log Bind Parameters Demo

This is a simple demo showing how you can enable the log bind parameters.

This is a copy from the [Quarkus Quick Start project - Hibernate ORM QuickStart](https://github.com/quarkusio/quarkus-quickstarts) with the change from PostgreSQL to H2 (so you don't need Docker to run this test) and the inclusion of these parameters:
```
...
Excute:
```
$ curl localhost:8080/fruits/1
```

### Check the bind parameters on the log
...
2022-05-29 19:02:15,193 TRACE [org.hib.typ.des.sql.BasicBinder] (executor-thread-0) binding parameter [1] as [INTEGER] - [1]
```
